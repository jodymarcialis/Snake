...
public class GamePanel extends JPanel implements ActionListener{ 
	...
	// will hold the x and y coordinates of the snake
		...
		if(running) {
			...
			for(int i = 0; i < bodyParts; i++) {
				...
				if(i == 0) {
					...
					/*
					 * Changes the snake's color randomly
					 * Can be used if he eats a golden apple (maybe ?)
					 * the apple's color is chosen randomly 
	...
	public void move() {
		// on déplace chaque partie du corps du serpent (de 1)
